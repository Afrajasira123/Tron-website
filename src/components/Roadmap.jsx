  ...
  return (
    <section className="relative py-28 bg-transparent overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        {/* Section Headline */}
        <h2 className="text-4xl sm:text-6xl font-extrabold tracking-tight text-white mb-20 leading-tight">
          From learner to hired,<br />
          in{' '}
        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          <div
            ...
            style={{
              background: 'linear-gradient(90deg, rgba(168,85,247,0.15) 0%, rgba(168,85,247,0.5) 15%, rgba(168,85,247,0.5) 85%, rgba(168,85,247,0.15) 100%)',
                ...
                >
                  ...
                  <div className="relative mb-6">
                    ...
                    <div
                      ...
                      style={{
                        background: 'radial-gradient(circle at 48% 8%, #ab47bc 0%, #8e24aa 38%, #5a1078 72%, #2c053d 100% )',
