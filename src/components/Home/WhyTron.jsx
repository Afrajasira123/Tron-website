...
export default function WhyTron() {
  return (
    <section id="why-tron" className="relative py-14 sm:py-20 lg:py-24 bg-transparent overflow-hidden">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="max-w-2xl mb-12 sm:mb-16 lg:mb-20">
          ...
          <h2 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-white uppercase leading-[1.1] mb-5">
            Everything you
            <br />
            need to actually
            <br />
        ...
        <div className="space-y-8 sm:space-y-12 lg:space-y-16 max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div className="flex items-center justify-center md:justify-start">
              <span
                className="text-6xl sm:text-7xl md:text-8xl font-black text-transparent font-poppins tracking-tighter"
                style={{ WebkitTextStroke: "1px #D074F0" }}
              >
                01
              </span>
            </div>
            <div className="p-6 sm:p-8 md:p-10 rounded-2xl bg-[#1f0b2a] border border-purple-500/20 shadow-xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div className="p-6 sm:p-8 md:p-10 rounded-2xl bg-[#1f0b2a] border border-purple-500/20 shadow-xl order-2 md:order-1">
