  ...
  return (
    <section id="events" className="relative py-24 bg-transparent overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10 text-center">
        ...
        <p className="max-w-2xl mx-auto text-xs sm:text-sm text-gray-400 font-light leading-relaxed mb-16">
          At Tron Digital we believe in celebrating life, not just living it. The Tron family celebrates all festivals, birthdays of team members, and indulges in good natured frolic during team outings. After all, all work and no play makes Jack a dull boy!
        </p>
            ...
            {col1.map((item, index) => (
              ...
              >
                <img
                  src={item.src}
                  alt={item.alt}
                  className={`w-full ${index === 1 ? 'h-[500px]' : 'h-auto'
